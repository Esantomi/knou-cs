...
- **정규형(Normal Form: NF)**
  ...
  - 정규형의 분류  
    ...
    - **제1정규형(1NF)**
      ...
      - 제1정규화가 필요한 릴레이션  
        ![제1정규화가 필요한 릴레이션](https://user-images.githubusercontent.com/61646760/152687015-ae733ac8-6bae-443e-8bdd-9af73c942c9f.png)
      ...
      - [제1정규화를 적용한 릴레이션](https://user-images.githubusercontent.com/61646760/152688342-4e534d7b-77f9-4c41-8892-eca80ad1e4c7.png)
...
- **정규화(Normalization)**
  - 특정 정규형의 조건을 만족하도록 릴레이션과 속성을 재구성하는 과정
    - 재구성은 하나의 릴레이션을 여러 개의 릴레이션으로 분할하는 과정
  - 정규화의 기능
